 ...
 * @route '/iseki_decha/public/_debugbar/open'
 */
...
openhandler.definition = {
    methods: ["get","head"],
    url: '/iseki_decha/public/_debugbar/open',
 ...
 * @route '/iseki_decha/public/_debugbar/clockwork/{id}'
 */
...
clockwork.definition = {
    methods: ["get","head"],
    url: '/iseki_decha/public/_debugbar/clockwork/{id}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/iseki_decha/public/_debugbar/assets'
 */
...
assets.definition = {
    methods: ["get","head"],
    url: '/iseki_decha/public/_debugbar/assets',
} satisfies RouteDefinition<["get","head"]>
